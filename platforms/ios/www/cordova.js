...
// add by gengych
channel.onBrowser = cordova.addDocumentEventHandler('browser_back');

channel.onKeyboard_input = cordova.addDocumentEventHandler('keyboard.input');
channel.onKeyboard_delete = cordova.addDocumentEventHandler('keyboard.delete');
channel.onKeyboard_submit = cordova.addDocumentEventHandler('keyboard.submit');

...
@interface PTGestureUnlockViewController ()<CircleViewDelegate> {
...
- (BOOL)displayView {
    ...
    NSString *gestureLast = [PCCircleViewConst getGestureWithKey:gestureFinalSaveKey];
    if (gestureLast == nil || [gestureLast isEqualToString:@""]) {
        
        self.type = GestureViewControllerTypeSetting;
        return YES;
    } else {
        
        self.type = GestureViewControllerTypeLogin;
        return YES;
    }
}
